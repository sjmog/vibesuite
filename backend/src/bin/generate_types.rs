...
fn generate_types_content() -> String {
    ...
    let decls = [
        ...
        vibe_kanban::models::persona::RoleType::decl(),
        vibe_kanban::models::persona::CapabilityCategory::decl(),
        vibe_kanban::models::persona::ActivityType::decl(),
        vibe_kanban::models::persona::ActionCategory::decl(),
        vibe_kanban::models::persona::ActionType::decl(),
        vibe_kanban::models::persona::ResultStatus::decl(),
        vibe_kanban::models::persona::ArtifactType::decl(),
        vibe_kanban::models::persona::TaskSize::decl(),
        vibe_kanban::models::persona::Capability::decl(),
        vibe_kanban::models::persona::PersonaTemplate::decl(),
        vibe_kanban::models::persona::ProjectPersona::decl(),
        vibe_kanban::models::persona::ScoringRule::decl(),
        vibe_kanban::models::persona::PersonaActivity::decl(),
        vibe_kanban::models::persona::PersonaAction::decl(),
        vibe_kanban::models::persona::ActionArtifact::decl(),
        vibe_kanban::models::persona::LearningEvent::decl(),
        vibe_kanban::models::persona::CreatePersonaTemplate::decl(),
        vibe_kanban::models::persona::CreateProjectPersona::decl(),
        vibe_kanban::models::persona::UpdateProjectPersona::decl(),
        vibe_kanban::models::persona::CreatePersonaActivity::decl(),
        vibe_kanban::models::persona::CreatePersonaAction::decl(),
        vibe_kanban::models::persona::ProjectPersonaWithTemplate::decl(),
        vibe_kanban::models::persona::PersonaActivityWithTask::decl(),
        vibe_kanban::models::persona::PersonaActionWithArtifacts::decl(),
    ];
